...
export default function Project1() {
  ...
  const [selectedProject] = useState(SAMPLE_PROJECTS[0]); // Use first project as template

  const projectTasks = [
    {
      id: 1,
      name: "Project Requirements & Planning",
      status: "completed",
      assignee: "John Doe",
      dueDate: "2024-01-15",
      priority: "high",
  ...
  const projectMilestones = [
    { name: "Project Kickoff", date: "2024-01-01", status: "completed" },
    { name: "Design Phase Complete", date: "2024-02-15", status: "completed" },
    {
    ...
    { name: "Final Release", date: "2024-04-30", status: "pending" },
  ];
  ...
  return (
    <div className={PAGE_LAYOUTS.main}>
      <PageHeader
        ...
        description="A comprehensive e-commerce solution with modern architecture and scalable design"
        actions={
          <>
          ...
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold">Apr 30, 2024</p>
              </div>
            </div>
          </CardContent>
        </Card>
                ...
                <CardContent className="space-y-4">
                  <div className="prose max-w-none">
                    <p className="text-gray-700">
                      This comprehensive e-commerce platform development project
                      aims to create a modern, scalable online shopping
                      solution. The platform will feature advanced user
                      management, product catalog, shopping cart functionality,
                      payment processing, and administrative tools.
                    </p>
                    <p className="text-gray-700">
                      Key features include responsive design, real-time
                      inventory management, multi-vendor support, analytics
                      dashboard, and integration with major payment gateways.
                    </p>
                  </div>
              ...
              <div className="space-y-4">
                {projectMilestones.map((milestone, index) => (
                  ...
                  >
                    ...
                    >
                      {getTaskStatusIcon(milestone.status)}
                    </div>
